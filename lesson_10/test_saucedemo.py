...
def test_shopping_cart_total():
    ...
    def create_page_objects(driver):
        ...
        # на самом деле — checkout-step-one
        cart_page = Saucedemo_cart_page(driver)
    ...
    @allure.step(
        "Проверка итоговой суммы (ожидается {expected}, получено {actual})"
    )
    ...
    auth_page, main_page, cart_page, checkout_page = create_page_objects(
        driver)
